...
def test_pca_preprocessing(zero_mean_samples=False, use_remapping=False):
    ...
    print(f"PCA EER (zero_mean_samples={zero_mean_samples}, use_remapping={use_remapping}): {eer:.6f} at threshold {th:.4f}")

if __name__ == "__main__":
    test_pca_preprocessing(zero_mean_samples=False, use_remapping=False)
    test_pca_preprocessing(zero_mean_samples=True, use_remapping=False)
    test_pca_preprocessing(zero_mean_samples=False, use_remapping=True)
    test_pca_preprocessing(zero_mean_samples=True, use_remapping=True)
